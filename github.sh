...
export name='recomecosobrio'
export email="trabalhotcc001@gmail.com"
export repositorio="https://github.com/Trabalhotcc001/recomecosobrio.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aulaa-$(date -I)"
